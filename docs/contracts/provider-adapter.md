...
- The `LearningProviderAdapter` interface: catalogue search, course details, enrolment request,
  completion import, health check and reconciliation (`docs/internal/SIH26101_TEAM_ORCHESTRATION.md` section 5,
...
See `docs/internal/SIH26101_TEAM_ORCHESTRATION.md` section 8, "Cross-lane handoff". A live adapter additionally
